<head>
    <link href='css_hotels/bootstrap.css' rel='stylesheet' />
    <link href='css_hotels/rotating-card.css' rel='stylesheet' />
...
$('#get<?php echo $hid;?>').click(function() {
     ...
     $.post('h_reviewdisplay.php',{postid:id},function(data){
