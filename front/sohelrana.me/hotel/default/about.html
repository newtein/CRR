...
<!-- Mirrored from sohelrana.me/hotel/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Apr 2017 14:59:05 GMT -->
<head>
    <title>Centralised Review System - about us</title>
...
<header class="main-header">
    <object type= "text/html" data = "com_header.html">  </object>
</header>
<!-- Header End -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-area">
                    <h2>ABout Us</h2>
                    <p>Whether you're looking to see the review of hotels or flights or restaurant or company, we really are the people for you to come to.</p>
                    ...
                    <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                        <div class="carousel-outer">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <img src="img/restaurant.jpg" class="img-preview" alt="About">
                                </div>
                                <div class="item">
                                    <img src="img/plane.jpg" class="img-preview" alt="About">
                                </div>
                                <div class="item active">
                                    <img src="img/company.jpg" class="img-preview" alt="About">
                                </div>
                            </div>
                            <!-- Controls -->
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="about-box">
                    ...
                    <div class="header bg-danger clearfix">
                        ...
                        <img src="img/profile-01.jpg" alt="profile-01" class="profile-img">
                    </div>
                    <!-- Detail -->
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="about-box">
                    ...
                    <div class="header bg-primary clearfix">
                        <h2>Harshit Gujral</h2>
                        <img src="img/profile-02.jpg" alt="profile-02" class="profile-img">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="about-box">
                    ...
                    <div class="header bg-gray clearfix">
                        <h2>Nipun Mittal</h2>
                        <img src="img/profile-03.jpg" alt="profile-01" class="profile-img">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation </p>
...
<!-- Mirrored from sohelrana.me/hotel/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Apr 2017 14:59:22 GMT -->
</html>