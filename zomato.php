...
<script src="http://maps.googleapis.com/maps/api/js?sensor=false&amp;libraries=places&types=(regions)&key=AIzaSyBH6tZ7PcZU-3TjNJdBIo1MnGhbaKCKCYg" type="text/javascript"></script>
    ...
    <!-- Custom stylesheet -->
    <link rel="stylesheet" id="style_sheet" type="text/css" href="css/style_zomato.css">
...
<div class = "main-part">
  <div class= "container">
  <h1><span>Search for</span> best <span>Restaurants</span></h1>
</div>
<form action="result_zomato.php" method="get">
  <div class="container">
<div class="row">
   <div class="col-sm-6 col-sm-offset-3">
       <div id="imaginary_container">
           <div class="input-group stylish-input-group">
               <input type="text" class="form-control" id="keyword" name="q" placeholder="Enter the location..." >
...
<input type="text" value="0" hidden name="pn">
</form>
