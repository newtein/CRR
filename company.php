<!DOCTYPE html>
  ...
  <head>
    ...
    <!-- Custom stylesheet -->
    <link rel="stylesheet" id="style_sheet" type="text/css" href="css/style_comp.css">
...
<div class = "main-part">
  <div class= "container">
  <h1><span>Welcome to the</span>  <span> Workplaces</span></h1>
</div>
<form action="company_result.php" method="get">
  <div class="container">
<div class="row">
   <div class="col-sm-6 col-sm-offset-3">
       <div id="imaginary_container">
           <div class="input-group stylish-input-group">
               <input type="text" class="form-control" name="company" placeholder="Workplace..." >
			    <input type="text" class="form-control" id="keyword" name="location" placeholder="Location..." >
...
<input type="text" value="1" hidden name="pn">
</form>
